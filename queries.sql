...
--Shorthand for departments and dept_manager
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
--Shorthand for retirement_info and dept_emp
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date 	
...
SELECT dept_no FROM dept_count
...
--Table relavent for sales team
SELECT emp_no, first_name, last_name, dept_name
INTO sales_team
FROM dept_info
WHERE dept_name = 'Sales';

--table relavent for sales and development teams
SELECT emp_no, first_name, last_name, dept_name
INTO sales_dev_team
FROM dept_info
...
--How many people are elegible for the mentor program. 
SELECT COUNT(me.emp_no)
FROM mentor_elig AS me

--Number employees per title eligible for mentor program
SELECT me.title, COUNT(me.emp_no) AS me_count 
INTO mentor_count
FROM mentor_elig AS me
GROUP BY title
ORDER BY me_count DESC;
